...
def PILtoTorch(pil_image, resolution, nearest_neighbor=False):
...
def standardize_quaternion(quaternions: torch.Tensor) -> torch.Tensor:
    """
    https://pytorch3d.readthedocs.io/en/latest/_modules/pytorch3d/transforms/rotation_conversions.html#quaternion_multiply
...
def matrix_to_quaternion(matrix: torch.Tensor) -> torch.Tensor:
    ...
    return standardize_quaternion(out)#standardize_quaternion(out)
